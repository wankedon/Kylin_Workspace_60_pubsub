...
std::unique_ptr< GeneralService::Stub> GeneralService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< GeneralService::Stub> stub(new GeneralService::Stub(channel, options));
  return stub;
}

GeneralService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ListAllNodes_(GeneralService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeInfo_(GeneralService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PostNodeControl_(GeneralService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeControlLastReply_(GeneralService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListAllTasks_(GeneralService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetTaskSumary_(GeneralService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AbortOne_(GeneralService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AbortAll_(GeneralService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void GeneralService::Stub::async::ListAllNodes(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::zb::dcts::node::NodesInfo* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::ListAllNodes(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::zb::dcts::node::NodesInfo* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::GetNodeInfo(::grpc::ClientContext* context, const ::zb::dcts::node::NodeId* request, ::zb::dcts::node::NodeInfo* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::GetNodeInfo(::grpc::ClientContext* context, const ::zb::dcts::node::NodeId* request, ::zb::dcts::node::NodeInfo* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::PostNodeControl(::grpc::ClientContext* context, const ::zb::dcts::node::server::NodeControl* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::PostNodeControl(::grpc::ClientContext* context, const ::zb::dcts::node::server::NodeControl* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::GetNodeControlLastReply(::grpc::ClientContext* context, const ::zb::dcts::node::NodeId* request, ::zb::dcts::node::server::NodeControl* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::GetNodeControlLastReply(::grpc::ClientContext* context, const ::zb::dcts::node::NodeId* request, ::zb::dcts::node::server::NodeControl* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::ListAllTasks(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::zb::dcts::node::server::ServerTasksInfo* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::ListAllTasks(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::zb::dcts::node::server::ServerTasksInfo* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::GetTaskSumary(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::zb::dcts::node::server::ServerTaskSummary* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::GetTaskSumary(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::zb::dcts::node::server::ServerTaskSummary* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::AbortOne(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::AbortOne(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
void GeneralService::Stub::async::AbortAll(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
...
void GeneralService::Stub::async::AbortAll(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
