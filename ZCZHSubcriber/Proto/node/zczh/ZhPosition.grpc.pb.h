...
class ZhPositionService final {
 public:
   ...
   public:
    ...
    class async_interface {
     public:
      ...
      virtual void GetRealtimeResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) = 0;
      ...
      virtual void GetReplayResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) = 0;
    };
   ...
   public:
    ...
    class async final :
     ...
     public:
      ...
      void GetRealtimeResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) override;
      ...
      void GetReplayResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) override;
     private:
      friend class Stub;
  ...
  class WithCallbackMethod_RealtimeStart : public BaseClass {
   ...
   public:
    WithCallbackMethod_RealtimeStart() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::zb::dcts::node::zczh::zhposition::TaskStartRequest, ::zb::dcts::node::TaskAccount>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::zb::dcts::node::zczh::zhposition::TaskStartRequest* request, ::zb::dcts::node::TaskAccount* response) { return this->RealtimeStart(context, request, response); }));}
    void SetMessageAllocatorFor_RealtimeStart(
        ::grpc::MessageAllocator< ::zb::dcts::node::zczh::zhposition::TaskStartRequest, ::zb::dcts::node::TaskAccount>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* RealtimeStart(
      ::grpc::CallbackServerContext* /*context*/, const ::zb::dcts::node::zczh::zhposition::TaskStartRequest* /*request*/, ::zb::dcts::node::TaskAccount* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  class WithCallbackMethod_ReplayRecordQuery : public BaseClass {
   ...
   public:
    WithCallbackMethod_ReplayRecordQuery() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::zb::dcts::TimeSpan, ::zb::dcts::node::zczh::zhposition::RecordReply>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::zb::dcts::TimeSpan* request, ::zb::dcts::node::zczh::zhposition::RecordReply* response) { return this->ReplayRecordQuery(context, request, response); }));}
    void SetMessageAllocatorFor_ReplayRecordQuery(
        ::grpc::MessageAllocator< ::zb::dcts::TimeSpan, ::zb::dcts::node::zczh::zhposition::RecordReply>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* ReplayRecordQuery(
      ::grpc::CallbackServerContext* /*context*/, const ::zb::dcts::TimeSpan* /*request*/, ::zb::dcts::node::zczh::zhposition::RecordReply* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_ReplayStart : public BaseClass {
   ...
   public:
    WithCallbackMethod_ReplayStart() {
      ::grpc::Service::MarkMethodCallback(4,
          new ::grpc::internal::CallbackUnaryHandler< ::zb::dcts::node::zczh::zhposition::ReplayStartRequest, ::zb::dcts::node::TaskAccount>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::zb::dcts::node::zczh::zhposition::ReplayStartRequest* request, ::zb::dcts::node::TaskAccount* response) { return this->ReplayStart(context, request, response); }));}
    void SetMessageAllocatorFor_ReplayStart(
        ::grpc::MessageAllocator< ::zb::dcts::node::zczh::zhposition::ReplayStartRequest, ::zb::dcts::node::TaskAccount>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* ReplayStart(
      ::grpc::CallbackServerContext* /*context*/, const ::zb::dcts::node::zczh::zhposition::ReplayStartRequest* /*request*/, ::zb::dcts::node::TaskAccount* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_GetReplayResult() {
      ::grpc::Service::MarkMethodCallback(7,
          new ::grpc::internal::CallbackServerStreamingHandler< ::zb::dcts::TaskId, ::zb::dcts::node::zczh::zhposition::Result>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::zb::dcts::TaskId* request) { return this->GetReplayResult(context, request); }));
    }
  ...
  typedef WithCallbackMethod_RealtimeStart<WithCallbackMethod_GetRealtimeResult<WithCallbackMethod_RealtimeStop<WithCallbackMethod_ReplayRecordQuery<WithCallbackMethod_ReplayStart<WithCallbackMethod_ReplayStop<WithCallbackMethod_ReplayAdjust<WithCallbackMethod_GetReplayResult<Service > > > > > > > > CallbackService;
   ...
   public:
    WithRawCallbackMethod_ReplayRecordQuery() {
      ::grpc::Service::MarkMethodRawCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ReplayRecordQuery(context, request, response); }));
    }
