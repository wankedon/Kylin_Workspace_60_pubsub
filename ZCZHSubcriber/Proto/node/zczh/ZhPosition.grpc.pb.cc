...
std::unique_ptr< ZhPositionService::Stub> ZhPositionService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< ZhPositionService::Stub> stub(new ZhPositionService::Stub(channel, options));
  return stub;
}

ZhPositionService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_RealtimeStart_(ZhPositionService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetRealtimeResult_(ZhPositionService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_RealtimeStop_(ZhPositionService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReplayRecordQuery_(ZhPositionService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReplayStart_(ZhPositionService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReplayStop_(ZhPositionService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReplayAdjust_(ZhPositionService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetReplayResult_(ZhPositionService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  {}
...
void ZhPositionService::Stub::async::RealtimeStart(::grpc::ClientContext* context, const ::zb::dcts::node::zczh::zhposition::TaskStartRequest* request, ::zb::dcts::node::TaskAccount* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::RealtimeStart(::grpc::ClientContext* context, const ::zb::dcts::node::zczh::zhposition::TaskStartRequest* request, ::zb::dcts::node::TaskAccount* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::GetRealtimeResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) {
...
void ZhPositionService::Stub::async::RealtimeStop(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::zb::dcts::node::NodeReply* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::RealtimeStop(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::zb::dcts::node::NodeReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::ReplayRecordQuery(::grpc::ClientContext* context, const ::zb::dcts::TimeSpan* request, ::zb::dcts::node::zczh::zhposition::RecordReply* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::ReplayRecordQuery(::grpc::ClientContext* context, const ::zb::dcts::TimeSpan* request, ::zb::dcts::node::zczh::zhposition::RecordReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::ReplayStart(::grpc::ClientContext* context, const ::zb::dcts::node::zczh::zhposition::ReplayStartRequest* request, ::zb::dcts::node::TaskAccount* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::ReplayStart(::grpc::ClientContext* context, const ::zb::dcts::node::zczh::zhposition::ReplayStartRequest* request, ::zb::dcts::node::TaskAccount* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::ReplayStop(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::ReplayStop(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::ReplayAdjust(::grpc::ClientContext* context, const ::zb::dcts::node::replay::AdjustRequest* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
...
void ZhPositionService::Stub::async::ReplayAdjust(::grpc::ClientContext* context, const ::zb::dcts::node::replay::AdjustRequest* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ZhPositionService::Stub::async::GetReplayResult(::grpc::ClientContext* context, const ::zb::dcts::TaskId* request, ::grpc::ClientReadReactor< ::zb::dcts::node::zczh::zhposition::Result>* reactor) {
