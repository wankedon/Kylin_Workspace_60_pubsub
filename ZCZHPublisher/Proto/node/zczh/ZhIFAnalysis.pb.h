...
inline void Header::set_record_id(ArgT0&& arg0, ArgT... args) {
 
 record_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void RecordDescriptor::set_record_id(ArgT0&& arg0, ArgT... args) {
