...
class ServerTaskElapsedTime PROTOBUF_FINAL :
 ...
 public:
  ...
  ~ServerTaskElapsedTime() override;
...
inline void NodeControl::set_detail(ArgT0&& arg0, ArgT... args) {
 
 detail_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
